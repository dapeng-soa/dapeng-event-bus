 ...
 */
public class BinlogRetryStrategy extends RetryStrategy {
    ...
    protected RetryPolicy createRetryPolicy() {
        SimpleRetryPolicy simpleRetryPolicy = new SimpleRetryPolicy(2, Collections.singletonMap(Exception.class, true));
